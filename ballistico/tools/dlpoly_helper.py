...
def import_second_dlpoly(atoms, replicas=(1, 1, 1), filename='dlpoly_files/Dyn.form'):
    ...
    dyn_mat = import_dynamical_matrix_dlpoly(n_unit_cell, replicas, filename)
...
def import_dynamical_matrix_dlpoly(n_particles, replicas=(1, 1, 1), filename='dlpoly_files/Dyn.form'):
    replicas = np.array(replicas)
...
def import_third_dlpoly(atoms, replicas=(1, 1, 1), filename='dlpoly_files/THIRD'):
