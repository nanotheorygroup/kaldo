...
class Plotter (object):
    ...
    def plot_dispersion(self, symmetry=None, n_k_points=200):
        ...
        if self.phonons.is_able_to_calculate:
            freqs_plot = bha.calculate_second_order_observable(self.phonons, 'frequencies', k_list)
            vel_plot = bha.calculate_second_order_observable(self.phonons, 'velocities', k_list)
