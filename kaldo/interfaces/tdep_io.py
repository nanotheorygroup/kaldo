...
def resolve_tdep_supercell(folder, supercell=(1, 1, 1), supercell_matrix=None):
    ...
    -------
    uc, sc : Atoms
        Primitive and supercell structures.
    diagonal_supercell : tuple[int, int, int] or None
        The (n1, n2, n3) tiling when M is diagonal; ``None`` when the
        tiling is non-diagonal (SNF path).
    """
