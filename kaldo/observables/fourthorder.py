...
class FourthOrder(ForceConstant):
    ...
    @classmethod
    def remap(cls, ifc4 : "FourthOrder", new_supercell : Atoms, tol : float = 1e-5) -> "FourthOrder":
        """
        Remaps the force constants in ifc2 to a super-cell representation. The result is a new
        SecondOrder object whose internal IFCs have size: (n_rep, n_uc, 3, n_rep, n_uc, 3, n_rep, n_uc, 3,n_rep, n_uc, 3)
